...
const homeTitleByLanguage = {
  fr: 'Restaurant au coeur du Cap d’Antibes',
  en: 'Restaurant in the heart of Cap d’Antibes',
  it: 'Ristorante nel cuore del Cap d’Antibes',
  de: 'Restaurant im Herzen von Cap d’Antibes',
  nl: 'Restaurant in het hart van Cap d’Antibes',
  es: 'Restaurante en el corazón del Cap d’Antibes',
